...
function buildWelcomeLetterJson(username: string): Record<string, unknown> {
  ...
  return {
    ...
    content: [
      ...
      blank(),
      p("Penned is about slow, thoughtful correspondence. Letters take at least 24 business hours to arrive, delivered at 4:00 PM in your timezone — just like the real post."),
      blank(),
      p("We hope it brings back the emotion of writing a letter again and the anticipation of receiving a letter in the mail."),
      blank(),
      p("This won't replace your email for everyday subscriptions and news updates. It won't replace your texts or social media to friends. But it will be a spam and junk free space to write longer updates to whomever you like."),
      blank(),
      p("A few things worth doing in the Settings:"),
      p("— Add a recovery email so you can reset your password if needed."),
      p("— Add your email, phone, or address so others can find you and send you letters (these are just identifiers to help others find you - they won't be used)."),
